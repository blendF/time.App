...
using TimeApp.DataAccess.Repository.IRepository;
using TimeApp.Models;
using TimeApp.Utility;

namespace TimeApp.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            {
                LanguageList = _unitOfWork.Language.GetAll().Select(i => new SelectListItem
                {
                    Text=i.Name,
                    Value = i.Id.ToString()
                }),
